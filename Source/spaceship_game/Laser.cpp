...
constexpr float LIFETIME = 1.5f; // (in seconds)
...
Laser::Laser(float x, float y, float speed, float angle, int player_num, int screenW, int screenH, EntityList& entities) :
