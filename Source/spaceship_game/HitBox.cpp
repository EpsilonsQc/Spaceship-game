...
// Size of rects drawn on corners by render_corners() (Should be an even integer)
...
int HitBox::getCenterX() const
{
	return _x + _w / 2;
}

int HitBox::getCenterY() const
{
	return _y + _h / 2;
}
...
Vector2 HitBox::getTl() const
{
	return _tl;
}

Vector2 HitBox::getTr() const
{
	return _tr;
}

Vector2 HitBox::getBl() const
{
	return _bl;
}

Vector2 HitBox::getBr() const
{
	return _br;
}
