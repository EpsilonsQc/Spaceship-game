...
ShipPart::ShipPart(float x, float y, float vx, float vy, float rotSpeed, float lifetime, int playerNum, int type, int screenW, int screenH) :
...
bool ShipPart::collides()
{
	return false;
}

bool ShipPart::doesCollide(int id)
{
	return false;
}
