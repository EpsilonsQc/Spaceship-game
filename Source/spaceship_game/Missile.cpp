...
constexpr float LIFETIME = 4.0f;    // (in seconds)
constexpr float TURN_SPEED = 2.0f;  // in rad/sec
constexpr int   NUM_PARTICLES = 10;
constexpr int   WIDTH = 12;
constexpr int   HEIGHT = 20;

Missile::Missile(float x, float y, float speed, float angle, int playerNum, int screenW, int screenH, EntityList& entities) :
